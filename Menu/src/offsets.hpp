...
namespace Wine::Offsets
{
  ...
  inline unsigned int oSeatbelt = 0x145C;  // byte 55:false 56:true
  inline unsigned int oInVehicle = 0x14C7; // int 16:false 0:true
  inline unsigned int pedArmor = 0x1530;   // float, 50: Online 100:Story Mode
  ...
  inline unsigned int pCWeaponInventory = 0x10D0;
  inline unsigned int oAmmoModifier = 0x78;
  ...
  inline unsigned int oBulletproofTires = 0x943;
  ...
  inline unsigned int oTampaMissles = 0x129C;
  inline unsigned int oTampa3CarMKMortar = 0x12A0;
  inline unsigned int oKhankali1 = 0x12A8;
  inline unsigned int oKhankali2 = 0x12AC;
  ...
  inline unsigned int oVExtras = 0x58B;  // short
  inline unsigned int oVParachute = 0x58C;

  // CReplayInterface Offsets

  inline unsigned int pCVehicleInterface = 0x10;
  ...
  inline unsigned int oWardrobeG = 2359296;
  inline unsigned int oWPointA = 5559;
  inline unsigned int oWPointB = 675;
  inline unsigned int oWComponent = 1333;
  inline unsigned int oWComponentTex = 1607;
  inline unsigned int oWProp = 1881;
  inline unsigned int oWPropTex = 2092;

  // Vehicle Menus Globals

  inline unsigned int oVMCreate = 2725260; // Create any vehicle.
  inline unsigned int oVMYCar = 2810287;   // Get my car.
  inline unsigned int oVGETIn = 2671444;   // Spawn into vehicle.
  inline unsigned int oVMSlots = 1585844;  // Get vehicle slots.

  // Some Player / Network times associated Globals

  inline unsigned int oPlayerGA = 2703656;
  inline unsigned int oPlayerIDHelp = 2689156;
  inline unsigned int oNETTimeHelp = 2703656;
}
